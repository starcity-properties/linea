...
export default class Floorplan {
  ...
  drawSlidingDoor(slidingDoor, slidingDoorStyle) {
    ...
    const doorSegment = [slidingDoor.outline[0], slidingDoor.outline[1]];
    const dottedSegment = [slidingDoor.outline[1], slidingDoor.outline[2]];
  ...
  drawDoor(door, doorStyle) {
    ...
    const hingePoint = door.outline[0];
    const endPoint = door.outline[1];
  ...
  drawBed(bed, bedStyle, pillows) {
    const bedObjs = [];
    const topLeftPoint = bed.outline[0];
    const topRightPoint = bed.outline[1];
    ...
    const bottomRightPoint = bed.outline[2];
  ...
  drawRectWithLabel(rect, rectStyle) {
    const rectObjs = [];
    const centerPoint = this.lineMidPoint(rect.outline[0], rect.outline[2]);
    rectObjs.push(
  ...
  drawDiagonal(a, b) {
    ...
    let label = [];
    const m = this.getMiddlePoint(a, b, d);
